...
> **⚠️ مرجع التنفيذ الرسمي للإنتاج الآن هو [`docs/MASTER_EXECUTION_PLAN.md`](docs/MASTER_EXECUTION_PLAN.md).**
> هذا الملف (`PLAN.md`) يبقى كخريطة طريق تاريخية للمراحل؛ أي تنفيذ يتبع الملف الكانوني أعلاه.
